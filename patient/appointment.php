        ...
        try {
            ...
            if (!$scheduleId) {
                ...
                if ($userEmail) {
                    ...
                    $bookSubject = "NovaCare - Appointment Booked (Token #$token)";
                    $bookBody = "Hello " . ($patient['name'] ?? 'Patient') . ",\n\n"
                        . "Your appointment booking has been submitted successfully.\n\n"
                        . "Token Number: $token\n"
                        . "Date: $appointmentDate\n"
                        . "Slot Time: $slotTime\n"
                        . "Status: Pending Hospital Confirmation\n\n"
                        . "You will receive an email update once the hospital reviews and confirms your appointment.\n\n"
                        . "Regards,\nNovaCare Patient Care Team";
                    send_email($userEmail, $bookSubject, $bookBody);
                }
            }
...
<body>
    ...
    <nav class="portal-mobile-drawer" id="portalDrawer">
        ...
        <div class="portal-drawer-user">
            <div class="avatar"><?= strtoupper(substr($patient['name'] ?? 'P', 0, 1)) ?></div>
            <span class="name"><?= htmlspecialchars($patient['name'] ?? 'Patient', ENT_QUOTES, 'UTF-8') ?></span>
        </div>
