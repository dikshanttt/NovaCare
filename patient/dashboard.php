...
<body>
    ...
    <header class="auth-navbar">
        ...
        <div style="display: flex; align-items: center; gap: 16px;">
            <div style="width: 36px; height: 36px; border-radius: 50%; background: var(--cherry); color: white; display: flex; align-items: center; justify-content: center; font-weight: bold;">
                <?= strtoupper(substr($patient['name'], 0, 1)) ?>
            </div>
            <span style="font-weight: 600; font-size: 14px;"><?= htmlspecialchars($patient['name'], ENT_QUOTES, 'UTF-8') ?></span>
    ...
    <div class="auth-subnav">
        ...
        <span class="auth-breadcrumb-current">/ Patient Dashboard</span>
    </div>
